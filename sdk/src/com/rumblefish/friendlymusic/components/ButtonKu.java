...
public class ButtonKu extends Button
{

    public ButtonKu(Context context)
    {
        super(context);
    }

    public ButtonKu(Context context, int i, int j, int k, int l)
    {
        super(context);
        setFrame2(i, j, k, l);
    }

    public ButtonKu(Context context, AttributeSet attributeset)
    {
        super(context, attributeset);
    }

    public ButtonKu(Context context, AttributeSet attributeset, int i)
    {
        super(context, attributeset, i);
    }

    public ButtonKu(Context context, FrameKu frameku)
    {
        super(context);
        setFrame2(frameku);
    }
